...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0f172a] dark:bg-[#080d1a] text-blue-300 py-12 px-6 md:px-12 border-t border-blue-500/20 transition-colors duration-300">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
          ...
          <div className="flex flex-col items-center md:items-end gap-6">
            <nav className="flex gap-8 text-sm font-medium uppercase tracking-widest text-gray-500">
            ...
            <div className="flex items-center gap-6">
              <div className="flex gap-5">
                <a href="https://www.linkedin.com/in/prateekmittal11" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  <Linkedin size={20} />
                </a>
                <a href="https://www.instagram.com/prateekmittaldesign" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  <Instagram size={20} />
                </a>
                <a href="https://www.behance.net/prateekmittaldesign" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
              ...
              <button onClick={scrollToTop} className="w-10 h-10 rounded-full border border-blue-700 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-all duration-300">
                <ArrowUp size={18} />
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm gap-4 pt-8 border-t border-blue-500/20">
          <p>&copy; {new Date().getFullYear()} Prateek. All rights reserved.</p>
          <div className="flex items-center gap-2 bg-blue-900/50 px-4 py-2 rounded-full border border-blue-500/20 group hover:border-blue-500/50 transition-all duration-300">
            <MapPin size={14} className="text-gray-500 group-hover:text-white transition-colors" />
            <span className="text-gray-500 group-hover:text-white transition-colors">Dehradun, India</span>
          </div>
        </div>
      </div>
    </footer>
